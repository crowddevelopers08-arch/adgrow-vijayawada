...
export default function LeadsTable({ 
  ...
  const filteredLeads = sortedLeads.filter((lead) => {
    ...
    const matchesConcern = concernFilter === "all" || lead.concern === concernFilter
    ...
    return matchesSearch && matchesStatus && matchesConcern && matchesDate && matchesForm
  })
  ...
  const getFormBadge = (formName: string) => {
    ...
    const formConfig: { [key: string]: { label: string, color: string } } = {
      'hair-transformation-form': { label: "Hair Transformation", color: "bg-purple-100 text-purple-800 border-purple-200" },
  ...
  // Get unique concerns for filter
  const uniqueConcerns = Array.from(new Set(leads.map(lead => lead.concern).filter(Boolean)))
  ...
  const exportToCSV = () => {
    const headers = ["Name", "Phone", "Email", "Concern", "Message", "City", "Age", "Status", "Form Name", "Source", "TeleCRM Synced", "Created At"]
        ...
        <CardContent className="p-6">
          ...
          <div className="mb-4 p-3 bg-yellow-50 border border-yellow-200 rounded">
            <p className="text-sm text-yellow-800">
              <strong>Debug:</strong> Total leads: {leads.length} | Filtered: {filteredLeads.length}
            </p>
          </div>
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-2">
                      ...
                      <span className="font-medium text-sm text-gray-900 capitalize">
                        {formName === 'hair-transformation-form' ? 'Hair Transformation' : 
          ...
          <div className="grid grid-cols-1 md:grid-cols-6 gap-4 mb-6 p-4 bg-gray-50 rounded-lg border border-gray-200">
            <div className="md:col-span-2">
              <div className="relative">
                ...
                <Input
                  placeholder="Search by name, phone, email, concern, form..."
                  value={searchTerm}
            ...
            <Select value={concernFilter} onValueChange={setConcernFilter}>
              ...
              <SelectContent className="bg-white border-gray-300 text-gray-900">
                <SelectItem value="all" className="focus:bg-gray-100">All Concerns</SelectItem>
                {uniqueConcerns.map(concern => (
                  <SelectItem key={concern} value={concern} className="focus:bg-gray-100">
                    {concern}
                  </SelectItem>
                ))}
              </SelectContent>
              ...
              <table className="w-full caption-bottom text-sm">
                <thead className="bg-gray-50 border-b border-gray-200">
                  <tr>
                    ...
                    <th className="h-12 px-4 text-left align-middle font-medium text-gray-700">Concern</th>
                ...
                <tbody>
                  {loading ? (
                    ...
                    <tr>
                      <td colSpan={8} className="p-8 text-center text-gray-500">
                        {leads.length === 0 ? 'No leads found in database' : 'No leads found matching your criteria'}
                      </td>
                    </tr>
                  ) : (
                      ...
                      return (
                        <Fragment key={lead.id}>
                          ...
                          >
                            ...
                            <td className="p-4 align-middle">
                              <div className="flex flex-col gap-1">
                                <span className="text-sm font-medium text-gray-900">{lead.concern || lead.procedure || "Not specified"}</span>
          ...
          <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mt-4 text-sm text-gray-600 gap-2">
            <div>
              ...
              {formFilter !== 'all' && ` • Form: ${
                formFilter === 'hair-transformation-form' ? 'Hair Transformation' : 
