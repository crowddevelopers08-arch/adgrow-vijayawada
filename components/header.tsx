...
export function Header() {
  ...
  // Load Google Tag Manager, conversion tracking, and Microsoft Clarity
  useEffect(() => {
    // Load gtag.js script
      ...
      >
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className={`flex items-center justify-between transition-all duration-300 ${
            ...
            {/* CTA Buttons */}
            <div className="relative flex items-center z-10 space-x-4">
              {/* Call button */}
              <a
                href="tel:9689056789"
              ...
              <a
                ...
                className={`hidden sm:flex items-center text-white font-medium py-2.5 px-6 rounded-full text-sm sm:text-base
                            bg-[#ec2028] shadow-md transition-all duration-300 ease-out
                            hover:scale-105 hover:shadow-[0_0_15px_#ec2028]
                            focus:outline-none focus:ring-2 focus:ring-[#ec2028]/60`}
              >
